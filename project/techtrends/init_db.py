...
def init_local_db():
    ...
    cur.execute("INSERT INTO posts (title, content) VALUES (?, ?)",
                ('KubeCon + CloudNativeCon 2021',
                 'The Cloud Native Computing Foundation flagship conference gathers leading technologists from leading open source and cloud native communities to further the education and advancement of cloud native computing.')
                )
